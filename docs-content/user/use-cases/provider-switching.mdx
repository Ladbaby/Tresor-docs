...
> **Tip:** If the downstream declares `api_formats: [anthropic]`, auto-translation kicks in automatically — the explicit `openai2anthropic` plugin in the pipeline is redundant but harmless (deduplication prevents double-conversion).
