...
The quickest way to get started on **Linux** or **macOS** — download the latest release with one command:
...
Navigate to `http://127.0.0.1:11510` in your browser to access the embedded dashboard for managing downstreams, rules, aliases, and settings visually.
