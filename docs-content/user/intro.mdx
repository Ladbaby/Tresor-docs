...
- 🏷️ **Model Aliasing** — Map one model name to another at the proxy layer. Your app sends `gpt-4o`, Tresor forwards as `claude-sonnet-4`. Hot-switch between backends without restarting.
