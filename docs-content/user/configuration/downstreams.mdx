...
The **Downstreams** tab shows all configured providers in a table with a Format column showing color-coded badges (OpenAI/Anthropic/OpenAI Responses). Click **Edit** to modify settings, add/remove model IDs, or fetch models from the provider.
