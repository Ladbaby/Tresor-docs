...
| `api_formats` | Optional | List of API formats this downstream speaks (`openai`, `anthropic`, `openai_responses`, `gemini`). Enables auto-translation when the request format doesn't match. |
...
| `openai` (`/v1/chat/completions`) | `gemini` | `openai2gemini` |
| `anthropic` (`/v1/messages`) | `openai` | `anthropic2openai` |
| `anthropic` (`/v1/messages`) | `openai_responses` | `anthropic2responses` |
| `anthropic` (`/v1/messages`) | `gemini` | `anthropic2gemini` |
| `openai_responses` (`/v1/responses`) | `openai` | `responses2openai` |
| `openai_responses` (`/v1/responses`) | `anthropic` | `responses2anthropic` |
| `openai_responses` (`/v1/responses`) | `gemini` | `responses2gemini` |
| `gemini` (`/v1beta/models/{model}:generateContent`) | `openai` | `gemini2openai` |
| `gemini` (`/v1beta/models/{model}:generateContent`) | `anthropic` | `gemini2anthropic` |
| `gemini` (`/v1beta/models/{model}:generateContent`) | `openai_responses` | `gemini2responses` |
...
|---|---|---|---|
| `openai-gpt4o` | OpenAI GPT-4o | `https://api.openai.com` | gpt-4o, gpt-4o-mini, gpt-3.5-turbo |
