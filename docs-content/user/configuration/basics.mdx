...
capture_payloads: false              # Capture the raw incoming request body and the raw downstream response body
icon_cache_dir: "~/.config/tresor/tresor-icons/" # Directory for cached model icon SVGs
