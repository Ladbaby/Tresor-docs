...
<Tabs>
  ...
  <TabItem value="extension" label="VS Code extension">
    In VS Code's setting page:
    ...
    :::warning
    For **remote connections**, if you set "ANTHROPIC_BASE_URL" to "http://127.0.0.1:11510", then Claude Code extension will try to connect port 11510 of remote server. In this case, you can either:
    - Map your PC's port 11510 to remote server's port 11510 using SSH RemoteForward (`-R 11510:localhost:11510`).
    ...
    - install Tresor also on that remote server (two Tresor instances).
    :::
  </TabItem>
</Tabs>
...
<Tabs>
  ...
  <TabItem value="extension" label="VS Code extension">
    Just restart VS Code and start using.
  </TabItem>
</Tabs>
