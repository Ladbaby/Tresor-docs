...
- `index.html` — Page structure and tab content (downstreams, aliases, rules, settings, about)
...
- Link between related pages using absolute paths with the full site path (e.g., `/Tresor-docs/docs/user/configuration`)
