---
title: Architecture
description: Internal architecture of the Tresor proxy and routing engine
---
...
│
├── engine/                # Core proxy handler + pipeline execution
│   ├── engine.go         # Proxy forwarding, model resolution, auth
